...
| CENTINELA includes an Analyst Console to inspect runtime cases, policy decisions, SLA status, retry events, and audit exports. | `apps/centinela_runtime/static/` | Supported | Operational UI integrated directly into the Runtime API without heavy external dependencies. |
